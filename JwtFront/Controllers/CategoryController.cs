using JwtFront.Models;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Text.Json;

namespace JwtFront.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> List()
        {
            ...
            var response = await client.GetAsync("http://localhost:5077/api/Categories");
            ...
            //{
            //    return RedirectToAction("AccessDined", "Account");
            //}
            else
            {
        ...
        {
            var client = this.CreateClient();
            await client.DeleteAsync($"http://localhost:5077/api/Categories{id}");
